...
def write_glyph_imgs_mp(opts):
    ...
    charset = open(f"../deepvecfont_v2/data/char_set/{opts.language}.txt", 'r').read()
...
def main():
    ...
    parser.add_argument("--ttf_path", type=str, default='../deepvecfont_v2/data/font_ttfs')
    parser.add_argument('--sfd_path', type=str, default='../deepvecfont_v2/data/font_sfds')
